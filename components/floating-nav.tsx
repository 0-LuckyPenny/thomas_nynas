...
export default function FloatingNav() {
  ...
  const handleItemClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    ...
    try {
      ...
      // If element exists by ID, scroll to it
      if (element) {
        element.scrollIntoView({ behavior: "smooth" })
        setIsOpen(false) // Close mobile menu on click
      } else {
        // If element is not found, show a toast
        toast({
          title: "Section not found",
          description: `The section "${targetId}" could not be found on the page.`,
          variant: "destructive",
        })
      }
    } catch (error) {
      ...
      toast({
        ...
        description: "There was an error navigating to the selected section.",
        variant: "destructive",
      })
    }
  }
