    ...
    <SectionContainer id="about" className="relative overflow-hidden">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10 rounded-lg overflow-hidden border border-white/10 shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end">
                <div className="p-4 text-white">
                  ...
                  <p className="text-sm text-white/80">Senior Senior Full Stack Python Engineer</p>
                </div>
              </div>
            </div>
        ...
        <div>
          <StaggeredContainer>
            <StaggerItem>
              <h3 className="text-2xl font-bold mb-4">Senior Senior Full Stack Python Engineer & AI Software Engineer</h3>
            </StaggerItem>
