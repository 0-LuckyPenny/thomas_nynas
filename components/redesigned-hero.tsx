...
export default function RedesignedHero() {
  ...
  const scrollToPages = ( type:string ) => {
  ...
  return (
    <CustomGradientBackground className="min-h-screen flex items-center">
      <motion.div
        ...
        className="container mx-auto px-4 py-16 md:py-24 items-center"
      ...
      >
        ...
        <div className="order-2 md:order-1 text-center">
          <ScrollReveal>
            <Badge className="mb-4 px-3 py-1.5 text-sm bg-primary/20 border-primary/30 text-primary">
              Senior Senior Full Stack Python Engineer
            </Badge>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-lg sm:text-xl md:text-2xl mb-6 md:mb-8 leading-relaxed px-[10%]">
          ...
          <ScrollReveal delay={0.4}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-center mb-6 md:mb-8">
              <Button
                size="lg"
                onClick={()=>scrollToPages('projects')}
        ...
        {/* <div className="order-1 md:order-2 flex justify-center mb-6 md:mb-0">
          <ScrollReveal direction="left">
            ...
            >
              <Image
                src="https://tvjrf8ogpgevtyum.public.blob.vercel-storage.com/Thomas_portfolio_images/avatar-YCDei9UJv4JHmKmKCpBfkwQel7FrCG.png"
                alt="Thomas Nynas"
                fill
